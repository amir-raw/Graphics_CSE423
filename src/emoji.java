...
public class emoji implements GLEventListener {
   ...
   private void eyebrew(GL2 gl, int cx,int cy,int r){
       int x = 0, y = r;
       int d = 1-r;
       int dE = 2*x+3, dSE = 2*(x-y)+5;
       gl.glBegin(GL2.GL_POINTS);
